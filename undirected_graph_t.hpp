...
class undirected_graph_t
{
  ...
  public:
    ...
    void save_edgelist(std::string edgelist_filename, std::string id = "names", int base = 0);
    void save_edgelist_using_names(std::string edgelist_filename);
    void save_edgelist_using_num(std::string edgelist_filename, int _base = 0);
  ...
  public:
    ...
    void modularity(std::string prop, std::string g_modularity_prop_name = "");
...
// =~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=
// =~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=
void undirected_graph_t::save_edgelist(std::string edgelist_filename, std::string id, int base)
{
  if(id == "names")
  {
    save_edgelist_using_names(edgelist_filename);
  }
  else if(id == "int")
  {
    save_edgelist_using_num(edgelist_filename, base);
  }
  else
  {
    std::cerr << "ERROR: Unknown vertex identifier type." << std::endl;
...
// =~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=
// =~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=
void undirected_graph_t::save_edgelist_using_names(std::string edgelist_filename)
{
  // Stream objects.
  std::fstream output_file;
  // Opens the stream and terminates if the operation did not succeed.
...
// =~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=
// =~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=
void undirected_graph_t::save_edgelist_using_num(std::string edgelist_filename, int _base)
{
  // Stream objects.
  std::fstream output_file;
  // Opens the stream and terminates if the operation did not succeed.
